        ...
        <div className="relative sm:max-w-sm w-full">
          ...
          <div className="relative w-full rounded-3xl px-6 py-4 bg-abitacoloGray -100 shadow-md">
            ...
            <form className="mt-10">
              ...
              <div className="mt-7">                
                <input type="email" placeholder="Fecha de nacimiento" className="mt-1 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0" />                           
              </div>

              <div className="mt-7">                
                <input type="email" placeholder="Nacionalidad" className="mt-1 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0" />                           
              </div>
